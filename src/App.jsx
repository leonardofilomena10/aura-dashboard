      ...
      <main className="max-w-7xl mx-auto px-6 mt-8">
        ...
        {activeTab === 'roi' && (
          <RoiTab
            theme={theme}
            roiWeeks={roiWeeks}
            setRoiWeeks={setRoiWeeks}
            roiClients={roiClients}
            setRoiClients={setRoiClients}
            pitchOutput={pitchOutput}
            setPitchOutput={setPitchOutput}
        ...
        {activeTab === 'profiles' && (
          <ProfilesTab
            ...
            newProfileLoc={newProfileLoc}
            setNewProfileLoc={setNewProfileLoc}
            newProfileAddr={newProfileAddr}
            setNewProfileAddr={setNewProfileAddr}
            newProfileCat={newProfileCat}
            setNewProfileCat={setNewProfileCat}
            handleCreateManualProfile={handleCreateManualProfile}
            handleStartOauthSimulation={handleStartOauthSimulation}
        ...
        {activeTab === 'clients' && (
          <ClientsTab
            ...
            newClientSub={newClientSub}
            setNewClientSub={setNewClientSub}
            newClientCompany={newClientCompany}
            setNewClientCompany={setNewClientCompany}
            newClientFee={newClientFee}
            setNewClientFee={setNewClientFee}
            handleCreateClient={handleCreateClient}
            handleDeleteClient={handleDeleteClient}
            activeProfileId={activeProfileId}
            activeClientEditBrandName={activeClientEditBrandName}
            setActiveClientEditBrandName={setActiveClientEditBrandName}
            activeClientEditColor={activeClientEditColor}
            setActiveClientEditColor={setActiveClientEditColor}
            activeClientEditMargin={activeClientEditMargin}
            setActiveClientEditMargin={setActiveClientEditMargin}
            saveWhiteLabelConfig={saveWhiteLabelConfig}
            triggerToast={triggerToast}
        ...
        {activeTab === 'settings' && (
          <SettingsTab
            ...
            setGoogleSSOPendingTool={setGoogleSSOPendingTool}
            handleStartOauthSimulation={handleStartOauthSimulation}
            triggerToast={triggerToast}
          />
        )}
